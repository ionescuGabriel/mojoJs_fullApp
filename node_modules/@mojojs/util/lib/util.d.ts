 ...
 */
export declare function headerParams(value: string): {
 ...
 */
export declare function headerQuote(value: string): string;
/**
 * Unquote HTTP header field parameter.
 */
export declare function headerUnquote(value: string): string;
/**
 * JSON pointers.
 */
